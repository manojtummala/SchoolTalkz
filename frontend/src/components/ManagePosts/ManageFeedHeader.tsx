    ...
    return (
        <div className="flex justify-between items-center p-2 mx-2 text-sm">
            ...
            <Menu
                ...
                transition
            >
                <MenuItem onClick={showDelete} className={'justify-center m-2'}>Delete post</MenuItem>
                <MenuItem onClick={showReport} className={'justify-center m-2'}>View Reported Persons</MenuItem>
            </Menu>
            ...
            {dlt && (
                <div className='w-full h-full top-0 left-0 right-0 bottom-0 fixed'>
                    ...
                    <div className='absolute top-1/3 left-1/3 ml-28 bg-white w-1/5 h-1/4 text-center rounded-xl'>
                        ...
                        <div className="block lg:flex pt-4 px-8 pr-4 pb-8 gap-2 w-full justify-center bg-white rounded-2xl shadow-2xl">
                            <button
                                type="submit"
...
export default ManageFeedHeader;
