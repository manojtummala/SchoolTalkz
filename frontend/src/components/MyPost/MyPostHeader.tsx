...
const MyPostHeader = () => {
    ...
    return (
        <div>
            {user.map((user) => (
                <div className="flex justify-between items-center p-2 mx-2 text-sm" key={user.id}>
                    <div className="flex gap-2 items-center">
                        ...
                        <div className="flex flex-col">
                            <span className="font-bold">{user.name} (Class V)</span>
                            <Link href=''><span className="text-[#D86500] border-b-2 border-orange-300">{user.school}</span></Link>
