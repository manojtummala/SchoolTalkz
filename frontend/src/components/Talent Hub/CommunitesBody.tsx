...
const commdetails: comdata[] = [
    { id: 1, name: 'Gloal Community', comm: 'Arts', number: '195', link: '/communityprofile' },
    { id: 2, name: 'Art Start', comm: 'Arts', number: '195', link: '/communityprofile' },
    { id: 3, name: 'Studio Art', comm: 'Dance', number: '195', link: '/communityprofile' },
    { id: 4, name: 'Brushes and Paints', comm: 'Arts', number: '195', link: '/communityprofile' },
    { id: 5, name: 'Dance with Kaushik', comm: 'Dance', number: '195', link: '/communityprofile' },
    { id: 6, name: 'Chess Minds', comm: 'Sports', number: '195', link: '/communityprofile' },
    { id: 7, name: 'Dance with Varun', comm: 'Dance', number: '195', link: '/communityprofile' },
    { id: 8, name: 'Brushes and Paints', comm: 'Arts', number: '195', link: '/communityprofile' },
    { id: 9, name: 'Sparking Community', comm: 'Arts', number: '195', link: '/communityprofile' },
    { id: 10, name: 'Play with Karun', comm: 'Sports', number: '195', link: '/communityprofile' },
