...
const commdetails: comdata[] = [
    ...
    { id: 3, name: 'Brushes and Paints', comm: 'Arts', number: '195', link: '/communityprofile', status: true },
    { id: 4, name: 'Brushes and Paints', comm: 'Arts', number: '195', link: '/communityprofile', status: true },
    { id: 5, name: 'Sparking Community', comm: 'Arts', number: '195', link: '/communityprofile', status: true },
    { id: 6, name: 'Gloal Community', comm: 'Arts', number: '195', link: '/communityprofile', status: true },
    { id: 7, name: 'Art Start', comm: 'Arts', number: '195', link: '/communityprofile', status: true },
