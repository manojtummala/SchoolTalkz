...
// const RenderDetails = ({ data }: Prop) => {
//     return (
//         <div className="flex flex-col">
//             {data.details.map((details, i) => (
//                 <div key={data.id}>
//                     <span className="font-bold">{details.name} (Class V)</span>
//                     <Link href='/schoolprofile'><span className="text-[#D86500] border-b-2 border-orange-300">Sparkling International School</span></Link>
    ...
    return (
        <div>
            ...
            <div className="px-7 py-2 text-sm">
                <span className="break-words">I won first place in a competition for paper carving</span>
...
export default GlobalFeedCardHeader;
