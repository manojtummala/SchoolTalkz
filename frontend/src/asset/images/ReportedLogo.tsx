...
const ReportedLogo = ({ mode, width, height }: SVGProp) => {
    return (
        <svg width={width ?? "46"} height={height ?? "35"} viewBox="0 0 46 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 17.5C0 7.83502 7.83502 0 17.5 0H46V35H17.5C7.83502 35 0 27.165 0 17.5Z" fill="url(#paint0_linear_257_886)" />
            <path d="M2 17C2 8.71573 8.71573 2 17 2H46V32H17C8.71573 32 2 25.2843 2 17Z" fill="white" />
            <path d="M3 17C3 9.26801 9.26801 3 17 3H46V31H17C9.26801 31 3 24.732 3 17Z" fill="url(#paint1_linear_257_886)" />
            ...
            <defs>
                <linearGradient id="paint0_linear_257_886" x1="23" y1="0" x2="23" y2="35" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#DE2135" />
                    <stop offset="1" stop-color="#7C090B" />
                </linearGradient>
                <linearGradient id="paint1_linear_257_886" x1="24.5" y1="3" x2="24.5" y2="31" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#DE2135" />
                    <stop offset="1" stop-color="#7C090B" />
                </linearGradient>
            </defs>
